    ...
    private RunEngine engine(RunStore store, VcsClient vcs, IssueTrackerClient issues) {
        ...
        var actions = new ActionRegistry(
            List.of(
                ...
                new PrConversationAction(new dev.smithyai.orchestrator.service.vcs.VcsClients(vcs)),
                ...
                review.commentReactAction(new dev.smithyai.orchestrator.service.vcs.VcsClients(vcs)),
                review.prReplyAction(new dev.smithyai.orchestrator.service.vcs.VcsClients(vcs)),
                review.prIsAssignedAction(new dev.smithyai.orchestrator.service.vcs.VcsClients(vcs)),
                review.prSetAssigneesAction(new dev.smithyai.orchestrator.service.vcs.VcsClients(vcs)),
